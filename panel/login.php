...
<head>
	...
	<link rel="icon" type="image/png" href="../favicona.ico" />
...
<body style="background-color: #999999;">
	<div class="limiter">
		<div class="container-login100">
			<div class='judul'>&copy; <a href="https://siplah.blibli.com/merchant-detail/SCMS-0193" class="txt2 hov1">
					<b><?= APLIKASI ?></b>
				</a>
			</div>
			...
			<div class="login100-more" style="background-image: url('../dist/img/blue.jpg');"></div>

			<div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50" style="background-image: url('../dist/img/blue.jpg');">
